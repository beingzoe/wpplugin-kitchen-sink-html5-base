...
if ( !class_exists('KST_ASIDE_ASIDES') ) { /* */ }
 
class KST_ASIDE_ASIDES {
     ...
     * @uses        KST_ASIDE_ASIDES::asides
     * @uses        KST_ASIDE_ASIDES::should_we_do_this()
	 ...
	 * 
	 * @since       0.1
	 * @uses        KST_ASIDE_ASIDES::do_in_loop()
	 * @uses        KST_ASIDE_ASIDES::output()
	 * @uses        add_action() WP function
	 */
	 ...
	 * @uses        KST_ASIDE_ASIDES::set_date()
	 * @uses        KST_ASIDE_ASIDES::add()
	 * @uses        KST_ASIDE_ASIDES::output()
	 * @uses        KST_ASIDE_ASIDES::current_day
